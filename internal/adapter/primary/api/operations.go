...
func RegisterOperationsAPI(api huma.API, application *app.App) {
	...
	huma.Register(api, huma.Operation{
		...
		jobs, err := operationFacade.ListOperations(ctx)
		if err != nil {
	...
	huma.Register(api, huma.Operation{
		...
		job, err := operationFacade.GetOperation(ctx, input.ID)
		if err != nil {
	...
	huma.Register(api, huma.Operation{
		...
		events, err := operationFacade.OperationEvents(ctx, input.ID)
		if err != nil {
	...
	huma.Register(api, huma.Operation{
		...
		if err := operationFacade.CancelOperation(ctx, input.ID); err != nil {

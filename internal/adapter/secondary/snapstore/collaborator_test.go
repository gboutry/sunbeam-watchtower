...
func TestCollaboratorManager_ListCollaborators(t *testing.T) {
	...
	collaborators, err := mgr.ListCollaborators(context.Background(), "my-snap")
	if err != nil {
...
func TestCollaboratorManager_InviteCollaborator(t *testing.T) {
	...
	err := mgr.InviteCollaborator(context.Background(), "my-snap", "carol@example.com")
	if err != nil {
...
func TestCollaboratorManager_ListCollaborators_Error(t *testing.T) {
	...
	_, err := mgr.ListCollaborators(context.Background(), "my-snap")
	if err == nil {

...
func (s *Service) List(ctx context.Context, source string, opts port.QueryOpts) ([]distro.SourcePackage, error) {
...
func (s *Service) CacheStatus() ([]port.CacheStatus, error) {
	return s.cache.Status()
}

// ReverseDepends returns source packages that have pkg in their Build-Depends.
func (s *Service) ReverseDepends(ctx context.Context, pkg string, sources []ProjectSource, opts port.QueryOpts) ([]distro.SourcePackageDetail, error) {
